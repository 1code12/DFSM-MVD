...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path', help='funtions dic.', default='/media/thinkstation02/data/wwkfile/wwk_pycharm_project/CPG_process/Final_dataset/Reveal/raw_code/train')
    parser.add_argument('--start', help='start functions number to parsed', type=int, default=0)
    parser.add_argument('--end', help='end functions number to parsed', type=int, default=20000)
